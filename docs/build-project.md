...
const templates = [
  ...
  "nodejs12.x/cookiecutter-aws-sam-step-functions-with-connectors",
  "nodejs12.x/cookiecutter-quick-start-cloudwatch-events",
  "nodejs12.x/cookiecutter-quick-start-web-with-connectors",
  ...
  "nodejs14.x/cookiecutter-aws-sam-step-functions-with-connectors",
  "nodejs14.x/cookiecutter-quick-start-cloudwatch-events",
  "nodejs14.x/cookiecutter-quick-start-web-with-connectors",
  ...
  "python3.7/cookiecutter-aws-sam-quick-start-web-with-connectors",
  "python3.8/cookiecutter-aws-sam-eventbridge-schema-app-python",
  "python3.8/cookiecutter-aws-sam-hello-python",
  "python3.8/cookiecutter-aws-sam-quick-start-web-with-connectors",
  "python3.8/cookiecutter-aws-sam-step-functions-sample-app",
  "python3.8/cookiecutter-aws-sam-step-functions-with-connectors",
  ...
  "python3.9/cookiecutter-aws-sam-quick-start-web-with-connectors",
  "python3.9/cookiecutter-aws-sam-step-functions-sample-app",
  "python3.9/cookiecutter-aws-sam-step-functions-etl-python",
  "python3.9/cookiecutter-aws-sam-step-functions-with-connectors",
